//Unless commented otherwise, this is not my creation and belongs to the original programmers.
...
public class MyGUIController_1<T>
{
    ...
    private Timer timer;
    private JButton stepButton, runButton, stopButton, NorthButton, SouthButton, EastButton, WestButton;	//The last 4 are mine.
     ...
     */
    public MyGUIController_1(WorldFrame<T> parent, GridPanel disp,
    ...
    private void makeControls()
    {
        ...
        stopButton = new JButton(resources.getString("button.gui.stop"));
		  NorthButton = new JButton(resources.getString("button.gui.north"));
		  SouthButton = new JButton(resources.getString("button.gui.south"));
		  EastButton = new JButton(resources.getString("button.gui.east"));
		  WestButton = new JButton(resources.getString("button.gui.west"));
