...
import java.awt.event.KeyListener; //My Change
import java.awt.event.KeyEvent;	  //My Change
...
public class GUIController<T>
{
    ...
    private JButton upButton, downButton, leftButton, rightButton, 
							interactButton, inventoryButton, moveButton;
		  ...
		  display.addKeyListener(new KeyListener()
		  {
			...
			public void keyTyped(KeyEvent event){
		  	...
		  	public void keyPressed(KeyEvent event){
				String in = "" + event.getKeyChar();
				parentFrame.getWorld().step(in);
		  }
		 });
    ...
    private void makeControls()
    {
        controlPanel = new JPanel();
			...
			inventoryButton = new JButton("Bag");
			interactButton = new JButton("\"A\" Button");
			moveButton = new JButton("Move");
        
        controlPanel.setLayout(new BoxLayout(controlPanel, BoxLayout.X_AXIS));
        controlPanel.setBorder(BorderFactory.createEtchedBorder());
        
        Dimension spacer = new Dimension(5, downButton.getPreferredSize().height + 10);
        ...
        controlPanel.add(Box.createRigidArea(new Dimension(5, 0)));
       	...
       	moveButton.addKeyListener(new KeyListener()
        {
