...
public class WorldFrame<T> extends JFrame
{
    ...
    private JTextArea messageArea, conversationArea;
    ...
    public WorldFrame(World<T> world)
    {
        ...
        content.add(new JScrollPane(messageArea), BorderLayout.NORTH);
		  ...
		  conversationArea = new JTextArea(2, 35);
		  conversationArea.setEditable(false);
		  conversationArea.setFocusable(false);
		  conversationArea.setBackground(Color.WHITE);
		  content.add(new JScrollPane(conversationArea), BorderLayout.SOUTH);
